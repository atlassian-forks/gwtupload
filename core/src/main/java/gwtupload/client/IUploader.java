...
public interface IUploader extends HasJsData, HasWidgets, IsWidget {
   ...
   */
  interface OnCancelUploaderHandler extends EventHandler {
   ...
   */
  interface OnChangeUploaderHandler extends EventHandler {
   ...
   */
  interface OnFinishUploaderHandler extends EventHandler {
   ...
   */
  interface OnStartUploaderHandler extends EventHandler {
   ...
   */
  interface OnStatusChangedHandler extends EventHandler {
   ...
   */
  interface UploaderConstants extends UploadStatusConstants {
